/**
 * Small feather-style icon set drawn inline so the portal ships no icon
 * dependency. `name` matches the values stored in document_categories.icon
 * plus the navigation/UI glyphs used around the app.
 */
...
const PATHS = {
  ...
  building: <><path d="M3 21h18" /><path d="M5 21V5a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v16" /><path d="M15 21V9h4a2 2 0 0 1 2 2v10" /><path d="M9 7h2M9 11h2M9 15h2" /></>,
  ...
  'check-circle': <><path d="M21.5 11.1V12a9 9 0 1 1-5.3-8.2" /><path d="M9 11l3 3 9-9" /></>,
